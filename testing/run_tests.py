...
def usage():
    print("""Unit-testing for placement_description.
...
LOG_FILENAME = "placement_desc.log"

#Set the loggers
logger = logging.getLogger('placement_desc')
...
#Import unit-tests
import test_uwds_sync, \
        test_descriptions

modules = [test_uwds_sync, \
            test_descriptions]
